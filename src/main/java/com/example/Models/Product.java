...
public class Product {
	...
	@OneToMany(mappedBy = "product",cascade = CascadeType.ALL,orphanRemoval = true)
	private List<Riview>reviews=new ArrayList<>();
	...
	public Product(Long id, String title, String description, int price, int discountedPrice, int discountPersent,
			...
			List<Riview> reviews, int numRatings, Category category, LocalDateTime createdAt) {
		super();
		this.id = id;
		this.title = title;
	...
	public List<Riview> getReviews() {
		return reviews;
	}

	public void setReviews(List<Riview> reviews) {
		this.reviews = reviews;
	}
