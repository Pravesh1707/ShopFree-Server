...
public class CreateProductRequest {
	...
	public int getDiscountersent() {
		return discountersent;
	}
	public void setDiscountersent(int discountersent) {
		this.discountersent = discountersent;
	}
